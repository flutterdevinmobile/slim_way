...
class UserUpdateTable extends _i1.UpdateTable<UserTable> {
  ...
  _i1.ColumnValue<double, double> currentWeight(double value) =>
      _i1.ColumnValue(
        table.currentWeight,
        value,
      );

  _i1.ColumnValue<double, double> targetWeight(double value) => _i1.ColumnValue(
    table.targetWeight,
    value,
  );
  ...
  _i1.ColumnValue<int, int> waterGlassSize(int? value) => _i1.ColumnValue(
...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'users') {
    ...
    currentWeight = _i1.ColumnDouble(
      'currentWeight',
      this,
    );
    targetWeight = _i1.ColumnDouble(
      'targetWeight',
      this,
    );
  ...
  late final _i1.ColumnDouble currentWeight;

  late final _i1.ColumnDouble targetWeight;
