...
import 'daily_log.dart' as _i7;
import 'food.dart' as _i8;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'daily_logs_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'userId',
          columnType: _i2.ColumnType.bigint,
      ...
      foreignKeys: [
        _i2.ForeignKeyDefinition(
          constraintName: 'daily_logs_fk_0',
          columns: ['userId'],
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'walks_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'userId',
          columnType: _i2.ColumnType.bigint,
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'weekly_weight_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'userId',
          columnType: _i2.ColumnType.bigint,
      ...
      foreignKeys: [
        _i2.ForeignKeyDefinition(
          constraintName: 'weekly_weight_fk_0',
          columns: ['userId'],
          referenceTable: 'users',
          referenceTableSchema: 'public',
          referenceColumns: ['id'],
  ...
  T deserialize<T>(
    ...
    if (t == _i7.DailyLog) {
      return _i7.DailyLog.fromJson(data) as T;
    }
    if (t == _i8.Food) {
      return _i8.Food.fromJson(data) as T;
    }
    if (t == _i9.Greeting) {
    ...
    if (t == _i11.Walk) {
      return _i11.Walk.fromJson(data) as T;
    }
    if (t == _i12.WeeklyWeight) {
      return _i12.WeeklyWeight.fromJson(data) as T;
    }
    if (t == _i1.getType<_i6.AiAnalysisResult?>()) {
      return (data != null ? _i6.AiAnalysisResult.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i7.DailyLog?>()) {
      return (data != null ? _i7.DailyLog.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i8.Food?>()) {
      return (data != null ? _i8.Food.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i11.Walk?>()) {
      return (data != null ? _i11.Walk.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.WeeklyWeight?>()) {
      return (data != null ? _i12.WeeklyWeight.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i10.User => 'User',
      _i11.Walk => 'Walk',
      _i12.WeeklyWeight => 'WeeklyWeight',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is Map<String, dynamic> && data['__className__'] is String) {
      return (data['__className__'] as String).replaceFirst('slim_way.', '');
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'DailyLog') {
      return deserialize<_i7.DailyLog>(data['data']);
    }
    if (dataClassName == 'Food') {
      return deserialize<_i8.Food>(data['data']);
    }
    ...
    if (dataClassName == 'Walk') {
      return deserialize<_i11.Walk>(data['data']);
    }
    if (dataClassName == 'WeeklyWeight') {
      return deserialize<_i12.WeeklyWeight>(data['data']);
    }
