...
--
-- Class DailyLog as table daily_logs
--
CREATE TABLE "daily_logs" (
    "id" bigserial PRIMARY KEY,
    "userId" bigint NOT NULL,
    "date" timestamp without time zone NOT NULL,
    "foodCal" double precision NOT NULL,
    "protein" double precision,
    "fat" double precision,
    "carbs" double precision,
    "waterMl" bigint,
    "walkCal" double precision NOT NULL,
    "netCal" double precision NOT NULL,
...
CREATE TABLE "users" (
    ...
    "waterGlassSize" bigint,
    "streakCount" bigint NOT NULL DEFAULT 0,
    "lastFoodLogDate" timestamp without time zone,
    "activityLevel" text,
    "monthlyWeightLossGoal" double precision,
    "dailyCalorieGoal" bigint,
    "dailyWaterGoal" bigint
);
...
--
-- Class WeeklyWeight as table weekly_weight
--
...
--
-- Foreign relations for "daily_logs" table
--
ALTER TABLE ONLY "daily_logs"
    ADD CONSTRAINT "daily_logs_fk_0"
    FOREIGN KEY("userId")
    REFERENCES "users"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "walks" table
--
ALTER TABLE ONLY "walks"
    ADD CONSTRAINT "walks_fk_0"
    FOREIGN KEY("userId")
    REFERENCES "users"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "weekly_weight" table
--
ALTER TABLE ONLY "weekly_weight"
    ADD CONSTRAINT "weekly_weight_fk_0"
    FOREIGN KEY("userId")
    REFERENCES "users"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('slim_way', '20260427100736183', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260427100736183', "timestamp" = now();
